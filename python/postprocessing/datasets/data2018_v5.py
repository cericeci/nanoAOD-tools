...
SingleMuon = [
    ...
    ComponentContainer('SingleMuon_Run2018D', '/SingleMuon/Run2018D-Nano1June2019-v1/NANOAOD'),
...
""" #No longer in 2018!
DoubleElectron=[
    ComponentContainer('DoubleEG_Run2018B', '/DoubleEG/Run2018B-Nano1June2019-v1/NANOAOD'), 
    ComponentContainer('DoubleEG_Run2018C', '/DoubleEG/Run2018C-Nano1June2019-v1/NANOAOD'), 
    ComponentContainer('DoubleEG_Run2018D', '/DoubleEG/Run2018D-Nano1June2019-v1/NANOAOD'), 
    ComponentContainer('DoubleEG_Run2018A', '/DoubleEG/Run2018A-Nano1June2019-v1/NANOAOD'), 
]"""
